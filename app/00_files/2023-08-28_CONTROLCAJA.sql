...
--
-- Servidor: localhost
-- Tiempo de generación: 28-08-2023 a las 19:17:28
...
(103, '2023-08-23 22:20:23', 3, '67850', 0, 0, 1, 3, 4500, 38900, '17:20', '0', '', '', 300),
(104, '2023-08-24 21:08:30', 40, '4444', 1, 4, 0, 0, 0, 70000, '0', '0', '', '', 300);
...
(300, '2023-03-10', 1, 1, 345000, 36000, 381000, 3, '2023-03-10 12:08:27', '2023-08-22 15:18:21', 0, 2800, 378200),
...
(0, '--', '--', '--', '--', 4, 1, 'NO', 'NO', 'NO'),
(1, 'YULY', 'DIAZ', 'yudiaz', 'yudiaz', 1, 2, 'NO', 'SI', 'NO'),
(3, 'KAROL', 'PULIDO', 'kapulido', 'kapulido', 2, 2, 'NO', 'NO', 'NO'),
(4, 'MARINO', 'VICTORIA VELAZCO', 'mavictoria', 'mavictoria', 4, 2, 'SI', 'NO', 'NO'),
(7, 'CRISTIAN', 'MONSALVE', 'crimonsalve', 'etica2020', 2, 1, 'NO', 'NO', 'NO'),
(8, 'SYSTEM', 'ADMIN_DEL_SISTEMA', 'system', 'system2020', 3, 1, 'NO', 'NO', 'NO'),
(28, 'WINDI', 'SARRIA QUINTERO', 'wisarria', 'wisarria', 4, 1, 'SI', 'NO', 'NO'),
(30, 'ROSI', 'TORREALBA', 'torrealbar', '1122', 1, 2, 'NO', 'SI', 'NO');
...
(503, '2023-08-22 15:11:24', 'ALLEGRA', 'RENE', 20000, 28000, 8000, 30, 300, 'LOCAL');
...
--
ALTER TABLE `ACCESOS`
  MODIFY `acceso_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=231;
...
--
ALTER TABLE `DOMICILIOS`
  MODIFY `domicilio_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=105;
...
--
ALTER TABLE `TURNOS`
  MODIFY `turno_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=355;
...
--
ALTER TABLE `VENTAS`
  MODIFY `venta_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=504;
