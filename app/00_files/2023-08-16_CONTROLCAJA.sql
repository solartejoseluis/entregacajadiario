...
--
-- Servidor: localhost
-- Tiempo de generación: 17-08-2023 a las 00:18:13
...
(490, '2023-08-14 19:37:35', 'ASPIRINA VERDE', 'COQUI', 7000, 10000, 3000, 1, 300, 'LOCAL'),
(491, '2023-08-15 01:06:26', 'AREPAS', 'PIPI', 4000, 10000, 6000, 1, 300, 'DOMI'),
(492, '2023-08-15 03:26:10', 'PAPA', 'TUTU', 3000, 5000, 2000, 1, 300, 'LOCAL');
...
--
ALTER TABLE `DOMICILIOS`
  MODIFY `domicilio_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=94;
...
--
ALTER TABLE `VENTAS`
  MODIFY `venta_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=493;
