...
--
-- Servidor: localhost
-- Tiempo de generación: 30-01-2023 a las 05:51:07
...
(112, '2023-01-11 19:43:02', 'BECLOMETASONA', 'YOLANDA', 15000, 25000, 10000, 2, 109),
(113, '2023-01-11 19:44:12', 'TRANEXAMICO', 'SALUD DESCUENTOS', 29700, 34700, 5000, 1, 109),
(122, '2023-01-18 03:00:26', 'PRODUCTO UNO', 'PRO UNO', 50000, 60000, 10000, 1, 205),
...
--
ALTER TABLE `ACCESOS`
  MODIFY `acceso_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=98;
...
--
ALTER TABLE `TURNOS`
  MODIFY `turno_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=208;
