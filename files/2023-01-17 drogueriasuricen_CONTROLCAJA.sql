...
-- Tiempo de generación: 17-01-2023 a las 20:18:16
...
--
-- Base de datos: `drogueriasuricen_CONTROLCAJA`
--
...
--
ALTER TABLE `TURNOS`
  MODIFY `turno_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=109;
...
--
ALTER TABLE `VENTAS`
  MODIFY `venta_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=122;
