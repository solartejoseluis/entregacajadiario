...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function recuperarRegistro(venta_id) {
    $.ajax({
      type: "GET",
      url:
        "venta_anterior_data.php?accion=consultar_venta&venta_id=" + venta_id,
      data: "",
      success: function (datos) {
  ...
  function modificarRegistro(registro) {
    $.ajax({
      type: "POST",
      url:
        "venta_anterior_data.php?accion=modificar_venta&venta_id=" +
        registro.venta_id,
      data: registro,
      success: function (msg) {
        listadoVentas.ajax.reload();
  ...
  function guardarRegistroCerrar(registro) {
    $.ajax({
      type: "POST",
      url:
        "venta_anterior_data.php?accion=guardar_cierre_turno&turno_id_anterior=" +
