...
document.addEventListener("DOMContentLoaded", function() {
  let listadoVentas = $("#tblVentas").DataTable({
    "ajax": {
      url: "venta_anterior_data.php?accion=listar_ventas",
      dataSrc: ""
    },
    "columns": [
      { "data": "venta_id" },
...
//  MOSTRAR LA FECHA ACTUAL
  ...
  function consultarDatosTurnoActual() {
    $.ajax({
      type: 'POST',
      url: 'venta_anterior_data.php?accion=consultarDatosTurnoActual',
      data: '',
  ...
  function cargarDatosUtilidadVendedor1() {
    $.ajax({
      type: 'GET',
      url: 'venta_anterior_data.php?accion=consultar_utilidad_vendedor1',
      data: '',
      success: function(datos) {
        $('#utilidadVendedor1').html(datos[0].utilidad_vendedor1);
  ...
  function cargarDatosUtilidadVendedor2() {
    $.ajax({
      type: 'GET',
      url: 'venta_anterior_data.php?accion=consultar_utilidad_vendedor2',
      data: '',
      success: function(datos) {
  ...
  function cargarDatosUtilidadVendedor3() {
    $.ajax({
      type: 'GET',
      url: 'venta_anterior_data.php?accion=consultar_utilidad_vendedor3',
      data: '',
      success: function(datos) {
  ...
  function cargarDatosUtilidadVendedor4() {
    $.ajax({
      type: 'GET',
      url: 'venta_anterior_data.php?accion=consultar_utilidad_vendedor4',
      data: '',
      success: function(datos) {
  ...
  function utilidadTurno() {
    $.ajax({
      type: 'GET',
      url: 'venta_anterior_data.php?accion=consultar_utilidad_turno',
      data: '',
      success: function(datos) {
  ...
  function guardarRegistro(registro) {
    $.ajax({
      type: 'POST',
      url: 'venta_anterior_data.php?accion=guardar_venta',
      data: registro,
  ...
  function recuperarRegistro(venta_id) {
    $.ajax({
      type: 'GET',
      url: 'venta_anterior_data.php?accion=consultar_venta&venta_id=' + venta_id,
      data: '',
      success: function(datos) {
  ...
  function modificarRegistro(registro) {
    $.ajax({
      type: 'POST',
      url: 'venta_anterior_data.php?accion=modificar_venta&venta_id=' + registro.venta_id,
      data: registro,
      success: function(msg) {
        listadoVentas.ajax.reload();
        cargaPantallaPrincipal();
  ...
  function borrarRegistro(venta_id) {
    ...
    $.ajax({
      type: 'GET',
      url: 'venta_anterior_data.php?accion=borrar_venta&venta_id=' + venta_id,
      data: '',
      success: function(msg) {
        listadoVentas.ajax.reload();
        cargaPantallaPrincipal();
  ...
  $('#npt_turno_saldo_caja').focusout(function calculoUtilidadCierre() {
    $.ajax({
      ...
      success: function(datos) {
        ...
        let entrega = parseFloat(totalSaldo.replace(/\$|\./g, "")) + parseFloat(totalUtilidad.replace(/\$|\./g, ""));
  ...
  function guardarRegistroCerrar(registro) {
    $.ajax({
      type: 'POST',
      url: 'venta_anterior_data.php?accion=guardar_cierre_turno&turno_id_anterior='+ registro.turno_id_anterior,
      data: registro,
      success: function(msg) {
        //listadoVentas.ajax.reload();
